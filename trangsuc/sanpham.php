    ...
    <div class="container d-flex py-5 row">
      ...
      <div class="col-6">
        ...
        <div class="p-3 border box-sizing d-flex border-danger">
          <div class="pe-3">
            <img src="https://curnonwatch.com/_next/image?url=https%3A%2F%2Fshop.curnonwatch.com%2Fmedia%2Fcatalog%2Fproduct%2Fcache%2Fd96eb53c23516f6ca600411b8495131f%2Fc%2Fu%2Fcuff-jackie-sil-shadow.png&w=1920&q=75" width="100px" alt="cuffs" />
          </div>
          <div>
            <p class="fw-bold text-danger fw-bold">
              BẠN ĐƯỢC TẶNG 1 VÒNG TAY BẤT KỲ KHI MUA ĐỒNG HỒ VÀ FREE SHIP SẢN PHẨM TỪ 999K TRỞ LÊN !
            </p>
            <p>Chương trình kéo dài từ 19/05 - 25/05</p>
          </div>
        </div>
        <div class="">
          <?php 
...
<p>*Chi tiết:</p>
<p class="mycolor">Hệ thống chưa cập nhật !</p>   
    </div>
        ...
        <table class="table fs-6">
          ...
          <tbody>
            <tr>
              ...
              <td>Toàn quốc</td>
              <td>
                <span>- Miễn phí vận chuyển với đơn hàng từ 999K trở
                  lên
                </span><br /><span>- 30,000đ với đơn hàng có giá trị thấp hơn 999K</span>
              </td>
              <td>
  ...
  <div class="slide_sp mt-4 mb-4">
    ...
    <div class="swiper-container swiper-containero container">
