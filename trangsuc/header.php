...
<head>
    ...
    <title>Thương hiệu đồng hồ BAWATCH</title>
</head>
                                                    ...
                                                    <div class="hover_nam hover_nam1 row">
                                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="header_hover">
                                                                        ...
                                                                        if($result_tt->num_rows > 0){
                                                                            while($row_tt = $result_tt->fetch_assoc()){
                                                                                ...
                                                                                <a class="d-flex mb-2 align-items-center" href="thuonghieu.php?id='.$row_tt['id'].'">
                                                                                    <img src="https://curnonwatch.com/_next/image?url=https%3A%2F%2Fshop.curnonwatch.com%2Fmedia%2Fcatalog%2Fcategory%2FMelis.png&w=128&q=75" alt="" />
                                                                ...
                                                                <p class="p-4 pb-0">
                                                                    <a href="category.php?id=11" class="d-block btn btn-ellipse btn-outline-primary mx-auto">XEM TẤT CẢ <i class="fas fa-arrow-right"></i></a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="img_scale">
                                                                <div class="nav_img">
                                                                    <img src="https://cms.curnonwatch.com/uploads/Dong_ho_nam_c50b910f66.jpg" alt="" width="100%" />
                                                                </div>
                                                    ...
                                                    <div class="hover_nam row">
                                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="header_hover">
                                                                ...
                                                                <p class="p-4 pb-0">
                                                                    <a href="category.php?id=12" class="d-block btn btn-ellipse btn-outline-primary mx-auto">XEM TẤT CẢ <i class="fas fa-arrow-right"></i></a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="img_scale">
                                                                <div class="nav_img">
                                                                    <a href="thuonghieu.php"><img src="https://cms.curnonwatch.com/uploads/Dong_ho_nu_857cd19c48.jpg" alt="" width="100%" /></a>
                                                                </div>
                                                ...
                                                <div class="hover_item hover_item4">
                                                    ...
                                                    <div class="hover_nam row align-items-center">
                                                        ...
                                                        <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                                                            ...
                                                            <p style="font-size: 28px" class="ps-4 color-red">Chương trình kéo dài từ 19/05 - 25/05</p>
                                                            <div class="d-flex">
                                        ...
                                        <ul class="hover_list">
                                                ...
                                                <div class="hover_item hover_item3">
                                                    ...
                                                    <div class="hover_nam hover_nu row align-items-center">
                                                        ...
                                                        <a href="category.php?id=16" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="nav_img">
                                                                <img width="100%" src="https://cms.curnonwatch.com/uploads/Phu_kien_thoi_trang_ddfb5fb629.jpg" alt="">
                                                            </div>
                                            ...
                                            <li class="">
                                                <div class="hover_item hover_item3">
                                                    ...
                                                    <div class="hover_nam row align-items-center">
                                                        ...
                                                        <a href="category.php?id=15" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                            <div class="nav_img">
                                                                <img width="100%" src="https://cms.curnonwatch.com/uploads/Phu_kien_thoi_trang_ddfb5fb629.jpg" alt="">
                                                            </div>
                                                            <p style="background-color: white;" class="d-flex p-3 justify-content-between"><span>VÒNG TAY NAM </span><span><i class="fas fa-arrow-right"></i></span></p>
                                                        </a>
