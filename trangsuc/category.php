...
<div class="container">
  <div class="banner-footer d-flex justify-content-center flex-column">
    <p class="text-secondary">MIX & MATCH</p></br>
    <button class="btn btn-dark text-white"><a href="index.php">TRANG CHỦ<a/></button>
  </div>
  <div class="mb-4">
    <?php
    if (isset($_GET['id'])) {
      echo 'Đồng Hồ thời trang từ lâu đã trở thành món phụ kiện không thể thiếu của các đấng mày râu. Thế nhưng làm thế nào để lựa chọn được những mẫu đồng hồ đẹp, phù hợp để nâng tầm phong cách là việc không phải
      ai cũng biết. Hướng dẫn cách chọn đồng hồ của chúng tôi sẽ giúp mọi việc trở nên dễ dàng hơn bao giờ !';
    } else {
      echo 'Đồng Hồ thời trang từ lâu đã trở thành món phụ kiện không thể thiếu của các đấng mày râu. Thế nhưng làm thế nào để lựa chọn được những mẫu đồng hồ đẹp, phù hợp để nâng tầm phong cách là việc không phải
      ai cũng biết. Hướng dẫn cách chọn đồng hồ của chúng tôi sẽ giúp mọi việc trở nên dễ dàng hơn bao giờ !';
    }
