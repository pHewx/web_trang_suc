    ...
    <main>
        ...
        if($result_slide ->num_rows > 0){
          while($row_slide = $result_slide->fetch_assoc()){
            ...
            <div class="carousel-item">
              <img src="./admin/light-bootstrap-dashboard-master/examples/images/slide/'.$row_slide['image'].'" class="d-block w-100" alt="'.$row_slide['image'].'">
              <div class="carousel-caption d-none d-md-block">
                <h1 class="text-white mb-5">SALE SALE</h1>
                <h2 class="text-white mb-5">MUA NGAY, NHẬN NGAY ƯU ĐÃI</h2>
                <h5 class="text-white mb-5">DUY NHẤT TRÊN WEBSITE BAWATCH</h5>
     ...
     data-aos-duration="1500">
                <p class="pt-4">#BAWATCH <span class="ms-2">#GOCCANHDI</span></p>
                <h2 class="mt-2">BAWATCH</h2>
                <h3 class=" mb-5">BST đồng hồ góc cạnh Mykonos</h3>
                <a href="category.php" class="btn btn-outline-primary btn_view mb-4"
                  ...
                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="d-flex align-items-center ">
                      ...
                      <div class="click_right click_right2 color-white">
                        <p>Địa chỉ:</p>
                        <p>#Số 123-Phú Diễn-Bắc Từ Liêm-Hà Nội</br>
                           #Số 22 Mai Dịch - Cầu Giấy - Hà Nội
                        </p>
                      </div>
                    </div>
                  </div>
