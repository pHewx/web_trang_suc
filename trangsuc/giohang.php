               ...
               ';
                ...
                <div class="container gio-hang-content-right col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="container-form">
                        ...
                        ?>
                        <button type="submit" name="" class="btn btn-primary">Đặt Hàng(Thanh toán online)</button>
                        <button type="submit" name="submit_click" class="btn btn-primary">Đặt Hàng(thanh toán khi nhận hàng)</button>
